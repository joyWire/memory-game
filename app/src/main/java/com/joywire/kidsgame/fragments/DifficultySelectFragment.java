...
import com.joywire.kidsgame.ui.DifficultyView;
...
public class DifficultySelectFragment extends Fragment {
    ...
    private String getBestTimeForStage(int theme, int difficulty) {
        ...
        if (bestTime != -1) {
            ...
            String result = String.format(getResources().getString(R.string.best_score)+"%02d:%02d", minutes, seconds);
            return result;
        } else {
            String result = getResources().getString(R.string.best_score_initial);
            return result;
        }
    }
